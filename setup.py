...
with open('bounder/__init__.py', 'r') as f:
    exec(f.readline())
...
def setup_package():
    ...
    setup(
        name=package,
        version=__version__,
        description="Analysis & Detection of Spatial Boundaries"
        long_description=long_description,
        long_description_content_type="text/markdown",
        url="https://github.com/ljwolf/%s" % package,
        maintainer="Levi Wolf",
        maintainer_email="levi.john.wolf@bristol.ac.uk",
